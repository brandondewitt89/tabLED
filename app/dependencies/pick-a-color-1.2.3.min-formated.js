 ...
 !function(a){
    ...
    a.fn.pickAColor=function(b){
        var c="ontouchstart"in window,d=(parseInt(a(window).width(),10)<767?!0:!1,"localStorage"in window&&null!==window.localStorage&&"object"==typeof JSON),e=document.all&&!window.atob,f=c?"touchstart.pickAColor":"mousedown.pickAColor",g=c?"touchmove.pickAColor":"mousemove.pickAColor",h=c?"touchend.pickAColor":"mouseup.pickAColor",i=c?"touchend.pickAColor":"click.pickAColor",j="dragging.pickAColor",k="endDrag.pickAColor",l=a.extend({
            showSpectrum:!0,showSavedColors:!0,saveColorsPerElement:!1,fadeMenuToggle:!0,showAdvanced:!0,showBasicColors:!0,showHexInput:!0,allowBlank:!1,inlineDropdown:!1,basicColors:{
                white:"fff",red:"f00",orange:"f60",yellow:"ff0",green:"008000",blue:"00f",purple:"800080",black:"000"
            }
        }
        ,b);
        ...
        ,p={
            rowsInDropdown:8,maxColsInDropdown:2
        }
        ;
        if(l.showSavedColors){
            var q=[];
        ...
        var s={
            ...
            ,getMoveableArea:function(a){
                ...
                ,c=a.parent(),d=a.outerWidth(),e=c.width(),f=c.offset();
            ...
            ,calculateHighlightedColor:function(){
                ...
                if("basic"===o){
                    ...
                    switch(c=tinycolor(q).toHsl(),q){
                        case"fff":b="darkenRight";
                        break;
                        case"000":b="lightenRight";
                        break;
                        default:b="bidirectional"
                    }
                }
                else{
                    ...
                    e=arguments[0].hsl.s,h=r.find(".spectrum-hue"),d=arguments[0].hsl.h,g=r.find(".spectrum-saturation"),i=r.find(".lightness-value"),f=r.find(".color-preview"),c={
                        h:arguments[0].hsl.h,l:.5,s:arguments[0].hsl.s
                    }
                    ,b="bidirectional"
                }
        ...
        return this.each(function(b){
            ...
            else if(document.cookie.match("pickAColorSavedColors-"+e.dataAttr))for(var g=document.cookie.split(";"),n=0;
            n<g.length;
            n++)g[n].match(e.dataAttr)&&(e.colors=g[n].split("=")[1].split(","));
            else e.colors=q;
            l.showAdvanced&&(c={
                h:0,s:1,l:.5
            }
            ,f.advancedSpectrums=f.thisWrapper.find(".advanced-list").find(".color-box"),f.advancedHighlightBands=f.thisWrapper.find(".advanced-list").find(".highlight-band"),f.hueSpectrum=f.thisWrapper.find(".spectrum-hue"),f.lightnessSpectrum=f.thisWrapper.find(".spectrum-lightness"),f.saturationSpectrum=f.thisWrapper.find(".spectrum-saturation"),f.hueHighlightBand=f.thisWrapper.find(".spectrum-hue .highlight-band"),f.lightnessHighlightBand=f.thisWrapper.find(".spectrum-lightness .highlight-band"),f.saturationHighlightBand=f.thisWrapper.find(".spectrum-saturation .highlight-band"),f.advancedPreview=f.thisWrapper.find(".advanced-content .color-preview")),s.addToSavedColors(o.defaultColor,e,f.savedColorsContent),s.updatePreview(f.thisEl),f.thisEl.focus(function(){
                ...
                thisFunction:s.closeDropdownIfOpen,theseArguments:{
                    button:f.colorPreviewButton,menu:f.colorMenu
                }
            }
                ...
                thisFunction:s.selectFromBasicColors,theseArguments:{
                    els:f,savedColorsInfo:e
                }
            }
                ...
                thisFunction:s.tapSpectrum,theseArguments:{
                    savedColorsInfo:e,els:f
                }
            }
