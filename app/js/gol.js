...
const checkNeighbors = (list, cellToCheck) => {
...
document.getElementById("btnPlay").onclick = function() {playGame()};
document.getElementById("btnPause").onclick = function() {pauseGame()};
